...
from common.file.resource_browser import ResourceBrowseView, ResourceFileView, ResourceSearchView
...
api_patterns = [
    ...
    path('assessment/user/activities/reply/<int:user_id>/', MyReviewView.as_view(), name='user_reply'),
    ...
    path(
        'upload/request/<int:request_id>/',
        ResourceUploadRequestDetailView.as_view(),
        name='resource-upload-request-detail',
    ),
    path(
