...
class Course(models.Model):
    ...
    school = models.ForeignKey(School, db_index=True, on_delete=models.CASCADE, verbose_name='院系')
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, null=True)
    created_time = models.DateTimeField(auto_now_add=True)
    semester = models.ManyToManyField(Semeseter, db_index=True, verbose_name="开课学期")
    average_rating = models.FloatField(default=0.0, db_index=True, verbose_name='平均评分', null=True)
    normalized_rating = models.FloatField(default=0.0, db_index=True, verbose_name='归一化平均评分', null=True)
    like_count = models.IntegerField(default=0, db_index=True, verbose_name='推荐')
    dislike_count = models.IntegerField(default=0, db_index=True, verbose_name='不推荐')
    review_count = models.IntegerField(default=0, db_index=True, verbose_name='评价数量')
