...
errcode_dict = {
    ...
    'captcha_required': '操作过于频繁，请完成验证码后继续',
    'invalid_captcha_proof': '验证码凭证无效或已失效',
    ...
    'reply_private': '课程评价回复私密',
    'review_login_private': '课程评价仅允许登陆用户查看',
    'reply_login_private': '课程评价回复仅允许登陆用户查看',
